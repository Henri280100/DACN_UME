...
import com.example.ume_frontend.CheckPassword;
import com.example.ume_frontend.R;
import com.example.ume_frontend.ui.activity.DoneActivity;
...
public class NewPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // EditText
        txtInputNewPass = findViewById(R.id.txtNewPassword);
        txtInputConfirmPass = findViewById(R.id.txtConfirmPass);
